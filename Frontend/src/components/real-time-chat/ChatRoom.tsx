...
export default function ChatRoom() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      {/* Header */}
      <header className="bg-gradient-to-r from-primary to-secondary p-4 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-white text-primary px-4 py-1 rounded-lg font-medium hover:bg-opacity-90 transition-opacity flex items-center space-x-1"
            >
              <FaSignOutAlt />
              <span>Leave</span>
            </button>
      ...
      <div className="flex-1 container mx-auto p-4 overflow-y-auto">
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-4 h-[65vh] overflow-y-auto">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-4">
          <div className="flex space-x-2">
            ...
            <button
              ...
              className="bg-accent text-white px-6 py-2 rounded-lg font-medium hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center"
            >
              Send
            </button>
          </div>
